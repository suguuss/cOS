...
// ------------ PROTOTYPES ------------
extern uint8_t ata_read_byte(uint32_t addr, uint16_t offset);
extern uint16_t ata_read_word(uint32_t addr, uint16_t offset);
extern uint32_t ata_read_dword(uint32_t addr, uint16_t offset);
